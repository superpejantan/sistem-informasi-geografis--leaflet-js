...
@section('content')
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ url('input/upload/foto') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <form action="{{ url('input/upload/foto') }}" method="POST" type="submit">
            {{ csrf_field() }}
            <div class="box-body">
...
<script type="text/javascript">
    ...
    var map = L.map('map').setView([-7.659431, 111.507444], 13);

    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(map);

    L.marker([-7.659431, 111.507444]).addTo(map)
